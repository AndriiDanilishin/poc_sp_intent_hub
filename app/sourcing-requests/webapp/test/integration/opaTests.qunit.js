...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "sourcingrequests/test/integration/FirstJourney",
    "sourcingrequests/test/integration/RequestsListJourney",
    "sourcingrequests/test/integration/RequestsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
